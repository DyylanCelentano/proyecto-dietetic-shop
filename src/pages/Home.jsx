  ...
  return (
    <div className="bg-[#FFF8ED] min-h-screen p-6 font-['Gabarito'] flex flex-col items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-7xl">
        {/* Card 1 */}
        <div className="w-full max-w-[600px] aspect-[16/9] bg-white p-4 rounded-xl border border-[#5E3B00] 
      ...
      <div className="w-full max-w-7xl mt-10 bg-[#FFF1D9] border border-[#5E3B00] rounded-xl shadow-md p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-[#E8CFA7] rounded-xl p-4 flex flex-col shadow-sm border border-[#5E3B00] h-full">
            <img src="" alt="producto-comunidad-1" className="w-full h-48 object-cover rounded-md mb-4" />
          ...
          <div className="bg-[#E8CFA7] rounded-xl p-4 flex flex-col shadow-sm border border-[#5E3B00] h-full">
            <img src="" alt="producto-comunidad-2" className="w-full h-48 object-cover rounded-md mb-4" />
            <div className="border-t border-[#5E3B00] my-2 -mx-4"></div>
            <div className="text-base text-black mt-2">
              <p>
                <span className="font-semibold">Producto: </span> 
              ...
              <p>
                <span className="font-semibold">Comentario: </span> 
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt, eaque! Id laboriosam hic voluptate. Totam.
              </p>
            </div>
          </div>

          <div className="bg-[#E8CFA7] rounded-xl p-4 flex flex-col shadow-sm border border-[#5E3B00] h-full">
            <img src="" alt="producto-comunidad-3" className="w-full h-48 object-cover rounded-md mb-4" />
            <div className="border-t border-[#5E3B00] my-2 -mx-4"></div>
            <div className="text-base text-black mt-2">
              <p>
                <span className="font-semibold">Producto: </span> 
      ...
      {/* Sección Blog */}
      <div className="flex flex-col items-center mt-16 text-center w-full">
        <h2 className="text-[#5E3B00] text-4xl font-bold mb-3">¿Querés ser parte de nuestra comunidad?</h2>
        <p className="text-[#3A2400] font-['Esteban'] text-xl">
          Compartí tus experiencias, aprendé y conectá con otros amantes de la alimentación saludable.        </p>
      ...
      {/* Sección Productos */}
      <div className="flex flex-col items-center mt-16 text-center w-full">
        <h3 className="text-[#5E3B00] text-3xl font-bold mt-8">Explora nuestros productos destacados</h3>
      </div>
      <div className="w-full max-w-7xl mt-10 bg-[#FFF1D9] border border-[#5E3B00] rounded-xl shadow-md p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">

          <div className="bg-[#FFFAF2] rounded-xl p-4 flex flex-col shadow-sm border-2 border-[#4D3000] h-full">
            <img src="" alt="producto-destacado-1" className="w-full h-48 object-cover rounded-md mb-4" />
            ...
            <div className="mt-2 text-base text-[#4D3000]">
              ...
              <p>
                <span className="font-semibold text-[#088714]">Precio: $349</span>
              </p>
              <p>
                <span className="font-semibold">Descripción: </span> 
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident ut pariatur itaque tempore numquam labore voluptates excepturi reprehenderit delectus?
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 bg-[#FFFAF2] rounded-xl p-4 flex flex-col justify-between shadow-sm border-2 border-[#4D3000] h-full">
            <img src="" alt="producto-destacado-2" className="w-full h-48 object-cover rounded-md mb-4" />
            <div className="border-t-2 border-[#4D3000] my-2 -mx-4"></div>
            <div className="mt-2 text-base text-[#4D3000]">
              <p>
                <span className="font-semibold">Nombre: </span> 
              ...
              <p>
                <span className="font-semibold text-[#088714]">Precio: $400</span>
              </p>
              <p>
                <span className="font-semibold">Descripción: </span> 
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat, asperiores.
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 bg-[#FFFAF2] rounded-xl p-4 flex flex-col justify-between shadow-sm border-2 border-[#4D3000] h-full">
            <img src="" alt="producto-destacado-3" className="w-full h-48 object-cover rounded-md mb-4" />
            <div className="border-t-2 border-[#4D3000] my-2 -mx-4"></div>
            <div className="mt-2 text-base text-[#4D3000]">
              <p>
                <span className="font-semibold">Nombre: </span> 
              ...
              <p>
                <span className="font-semibold text-[#088714]">Precio: $850</span>
              </p>
              <p>
                <span className="font-semibold">Descripción: </span> 
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore voluptates expedita ut unde doloremque incidunt!
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center mt-16 text-center w-full">
        <h2 className="text-[#5E3B00] text-4xl font-bold mb-3">¿Buscás más opciones saludables?</h2>
        <p className="text-[#3A2400] font-['Esteban'] text-xl">
          Conocé toda nuestra línea de productos dietéticos, sin TACC, orgánicos, proteicos y más.
        </p>
        <div className="flex flex-col sm:flex-row gap-12 my-6 text-xl">
          <Link to="/productos"
              className="px-20 py-2 bg-[#FFF6E8] border-2 border-[#4D3000] text-[#6D4400] font-semibold 
